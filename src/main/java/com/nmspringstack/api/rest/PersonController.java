...
import com.nmspringstack.service.PersonService;
import com.nmspringstack.service.PersonServiceEvent;

import org.springframework.http.HttpStatus;

@RestController
@RequestMapping(value = "/POC-personservice/v1/person")
public class PersonController extends AbstractRestHandler {
	...
	public void createPerson(@RequestBody Person person, HttpServletRequest request, HttpServletResponse response) {
		...
		response.setHeader("Location", request.getRequestURL().append(createdPerson.getId()).toString());
	}
	...
	public @ResponseBody Page<Person> getAllPerson(
		...
		return this.personService.getAllPerson(page, size);
	}
